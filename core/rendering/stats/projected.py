...
async def render_projected(
    ...
    im.text.draw_many([
        ...
        (f'&fWins', {'position': (160, 142), "align": "center", "font_size": 14}),
        (f'&fWeighted Wins', {'position': (410, 142), "align": "center", "font_size": 14}),
        (f'&fLevel', {'position': (660, 142), "align": "center", "font_size": 14}),
        (f'&fKills', {'position': (160, 247), "align": "center", "font_size": 14}),
        (f'&fFinals', {'position': (410, 247), "align": "center", "font_size": 14}),
        (f'&fBeds', {'position': (660, 247), "align": "center", "font_size": 14}),

        (f'&a{stats.wins:,} &f➡ &a{data["wins"]:,}', {'position': (160, 160), "align": "center", "font_size": 18}),
        (f'&c{stats.weightedwins:,} &f➡ &c{data["weightedwins"]:,}', {'position': (410, 160), "align": "center", "font_size": 18}),
        (f'{cur_level} &f➡ {new_level}', {'position': (660, 160), "align": "center", "font_size": 18}),
        (f'&9{stats.kills:,} &f➡ &9{data["kills"]:,}', {'position': (160, 265), "align": "center", "font_size": 18}),
        (f'&d{stats.finals:,} &f➡ &d{data["finals"]:,}', {'position': (410, 265), "align": "center", "font_size": 18}),
        (f'&e{stats.beds:,} &f➡ &e{data["beds"]:,}', {'position': (660, 265), "align": "center", "font_size": 18}),
        ...
        (f'&fProjected to hit {new_level} &fon {data["projected_date"]}', {"position": (410, 352), 'align': 'center',  'font_size': 16}),
